...
/**
 * @file ppl_time.h
 * @brief PPL Time Handling Routines
 */

/**
 * @defgroup PPL_TIME Time Handling
 * @ingroup PPL
 * @{
 */
...
/**
 * Structure for storing time in seconds
 * @defvar ppl_time_t
 */
  typedef int ppl_time_t;


/**
 * Get Time.
 */
    PPL_DECLARE (ppl_time_t) ppl_time (void);
