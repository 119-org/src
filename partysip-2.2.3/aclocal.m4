...
dnl
dnl @version $Id: ac_define_dir.m4,v 1.1 2003/01/03 18:51:41 aymeric Exp $
...
dnl
dnl @version $Id: type_socklen_t.m4,v 1.4 2002/11/22 12:13:03 aymeric Exp $
...
[
  ...
  if test $ac_cv_type_socklen_t != yes; then
    AC_DEFINE(socklen_t, int, [Define socklen_t if not yet done])
  fi
])
